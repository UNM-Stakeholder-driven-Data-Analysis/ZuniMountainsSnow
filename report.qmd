...
![An example of a random simulation of trees within 30mx30mr cell with 30% tree cover. 0 Represents bare ground, 100 represents tree-cover.](./GeneratedPlots/one30x30randSim.jpeg){#fig-randExample fig-align="center" width="400"}
...
All criteria were applied to each of the 100 simulated images and across all years. A zoomed in image of each criterion applied to one stochastic simulation for the year 2015 is shown in @fig-zoom. A comprehensive set of optimal images for each criteria is shown in @sec-optResults .
...
TODO: add activities assumed to effect tree cover.
...
Figures @fig-opt2015, @fig-opt2010, @fig-opt2005, @fig-opt2000 show optimal images resulting from each criteria applied to one simulation of tree cover.

![](./GeneratedPlots/optArea_yr2015.jpeg){#fig-opt2015}

![](./GeneratedPlots/optArea_yr2010.jpeg){#fig-opt2010} ![](./GeneratedPlots/optArea_yr2005.jpeg){#fig-opt2005}

![](./GeneratedPlots/optArea_yr2000.jpeg){#fig-opt2000}
