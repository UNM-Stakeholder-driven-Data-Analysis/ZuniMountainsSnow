...
![An example of a random simulation of trees 30x30 meter cell with 30% tree cover. 0 Represents bare ground, 100 represents tree-cover. (TODO: convert to ground and tree levels, color accordingly)](./GeneratedPlots/VisualizeRandomSampleForOneCell.png){#fig-randExample fig-align="center" width="400"}
...
A flow chart indicating the entire process is shown below
