...
The prediction was that the D-2 treatment within the Bluewater Ecosystem Management Project would create large gaps between trees, and therefore reduce the snow accumulation potential of the forest. The results confirm the prediction.

Although two of the seven criterion resulted in an increase in optimal area for snowpack accumulation, those criterion are not realistic models of snow accumulation and should be discounted. The unrealistic criteria are North Semicircle with minimum area of tree cover at 1 cell (9m^2^) and 2 cells (18 m^2^), respectively. These criteria effectively model snowpack accumulation as occurring in a semicircle around of one or two small trees, even if they stand alone in a large clearing. No evidence of such a pattern is found in Google Earth imagery. Instead snow appears on the north side of isolated patches canopy cover, not in a semicircle ranging from east to west. The North Semicircle criteria with minimum tree cover threshold set to 4 or 5 cells is a better model of this pattern, because at these threshold values it is more likely that an area designated as optimal will be to the north of tree cover, as well as protected by tree cover in other directions. These more realistic criteria result in a confirmation of the prediction (@fig-totOptArea, North Semicircle data).

The most reasonable criterion models snow accumulation as occurring on the north side of tree cover (North Line criteria) (see @sec-visAsses, North Line data). Both the generous (minimum cluster size=1cell) and more conservative (minimum cluster size=2cells) versions of this criteria result in a reduction in optimal area after thinning.

There is relatively small variation in total optimal area between stochastic simulations within the same year and criteria (see range columns in @tbl-results). For a particular criteria, specific spatial configurations of cover might have higher total optimal area and lower total sub-optimal bare ground. For example North Lines with minimum cluster size =1 will have highest optimal area when tree cover is arranged in lines of trees spaced at 15 meter intervals, running east to west. Similarly, lowest optimal area will occur when all the tree cover cells are bunched together in a north-south oriented cluster. While there may be some relatively high probability of these extremes occurring for one 30x30 m cell at a given percent cover, the probability that one of these extremes occurrs for all 3,602 cells in the study area is low. For a sufficiently large area, the simulations of 30x30 cells that result in extreme values will tend to cancel each other out. Judging by the low observed variation, the total extent of the thinning polygon, 3.24 km^2^, is sufficiently large to produce this effect. A future study investigating the effect of spatial scale on these results would be required to prove this.

#### A Notion of Optimal Density with Respect to Snow

#### Limitations

Observation of google earth imagery suggests that two more important factors for snow accumulation are aspect and elevation. Although less common, some clusters of tree cover did not have snow to the north, while some areas of bare ground greater than 15m from tree cover did have snow. This suggest other factors impact snow accumulation in this area. A clear large scale pattern of more snow on the north faces, and closer to the major ridge of the Zuñi Mountains, suggests that the missing factors are aspect and elevation. A future study that incorporates these factors will likely create better approximations of snow accumulation potential.

Ultimately the true snow accumulation is unknown. This study only investigates the *potential* of an area to accumulate snow.

This study simulates tree cover distribution with randomness. In reality there are likely non random spatial distributions in forests. Including models of non-random or psuedo-random distributions in the simulations could increase the realism. Alternatively, applying the North Line criterion to true tree cover distributions will greatly increase the certainty of the conclusion.

## Conclusions

For the D-2 Bluewater thinning project the snowpack accumulation potential decreased after thinning. This suggests that the potential for that forest area to integrate water into the soil has decreased. This conclusion is based on previous study based on measured and modeled data found that bare ground within 15m of tree cover has higher net snow water input than both tree covered areas and bare grount greater than 15m from tree cover[@broxton2015a]. These results are important because they allow USFS managers to understand how thinning treatments may affect the water status of the ecosystem. This result suggests that there are additional benefits to thinning beyond improving the resilience of forests to frequent-fire patterns.
